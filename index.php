              ...
              <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                  <div class="card text-center doctor-book-card">
                    ...
                    <div class="doctor-book-card-content tile-card-content-1">
                      <div>
                        <h3 class="card-title mb-0">Visit a Hospital</h3>
                        <a
                          href="search.php"
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="section-header">
                <h2>Book an appointment at a hospital</h2>
               
              </div>
              <div class="about-content">
                <p>
					HealthHub Bookings syncs your calendars while letting customers self-schedule and pay for appointments. 
					Our user interface auto-customizes for your industry, meaning you feel right at home. 
                </p>
                ...
                <div class="profile-widget">
                  ...
                  <div class="pro-content">
                    ...
                    <ul class="available-info">
                      <li>
                        <i class="fas fa-map-marker-alt"></i> Kigali, RW
                      </li>
                      <li>
                    ...
                    <div class="row row-sm">
                      <div class="col-6">
                        <a href="doctor-profile.php" class="btn view-btn"
                          >View Profile</a
                        >
                      </div>
                      <div class="col-6">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="footer-widget footer-menu">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="doctor-dashboard.php">Hospital Dashboard</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <div class="copyright-text">
                    <p class="mb-0">
                      &copy; 2021 HealthHub. All rights reserved.
                    </p>
                  </div>
                </div>
